...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallSupplierButton = (Button) findViewById(R.id.edit_call_supplier);
        ...
        mCallSupplierButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(supplierPhoneString)) {
                    String toast = (String) getString(R.string.editor_no_phone_number_available);
                    Toast.makeText(EditorActivity.this, toast, Toast.LENGTH_SHORT).show();
                    return;
                }
                // Present dialog asking if the user wants to call
                confirmUserWantsToCallDialog();
            }
        });
    ...
    private void saveBook() {
        ...
        values.put(BookContract.BookEntry.COLUMN_BOOK_SUPPLIER_PHONE_NUMBER, supplierPhoneString);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                if (TextUtils.isEmpty(nameString) || TextUtils.isEmpty(priceString) ||
                        TextUtils.isEmpty(quantityString) || TextUtils.isEmpty(supplierString) ||
                        TextUtils.isEmpty(supplierPhoneString)) {
                    Toast.makeText(this, getString(R.string.editor_fields_must_be_filled),
                            Toast.LENGTH_SHORT).show();
                    return true;
                }
    ...
    private void showUnsavedChangesDialog(
            DialogInterface.OnClickListener discardButtonClickListener) {
        // Create an AlertDialog with positive and negative buttons with click listeners
    ...
    private void confirmUserWantsToCallDialog() {
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(this);
        builder.setMessage(R.string.call_supplier_message);
        builder.setPositiveButton(R.string.call_supplier_yes, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                // intent to phone
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:" + mSupplierPhoneNumberEditText.getText().toString().trim()));
                startActivity(intent);
            }
        });
        builder.setNegativeButton(R.string.call_supplier_no, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                return;
            }
        });
